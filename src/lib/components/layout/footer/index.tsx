...
import {Facebook, Instagram, MailOpen, PhoneCall, Twitter, Youtube} from "lucide-react";
    ...
    return (
        <div className="px-20">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-2 border-t px-4 border-gray-100  py-10 ">
                <div className="grid grid-cols-3">
                    <div className="flex flex-col gap-2">
                        ...
                        <p className="text-sm">Call us from 8am to <br/> 12am ET.</p>
                        <Link className="text-sm hover:underline" href="tel:1001202">1-1020-1203123</Link>
                    </div>
                    <div className="flex flex-col gap-2">
                        <MailOpen/>
                        <h6 className="text-lg font-bold mb-2">Email</h6>
                        <p className="text-sm">Our response time is <br/> 1 to 3 business days.</p>
                        <Link className="text-sm hover:underline" href="mailto:alexcarvajal2404@gmail.com">Send
                            Message</Link>
                    </div>
                    <div></div>
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm mb-2">Get recommendations, tips, updates, promotions and more.</p>
            ...
            <footer className="text-gray-700 border-t border-gray-100">
                {/* Top Section */}
                <div
                    className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-100">
                    {/* Company Info */}
                    <div>
                ...
                {/* Bottom Section */}
                <div
                    className="max-w-7xl mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center text-sm text-gray-600">
                    {/* Left Section */}
