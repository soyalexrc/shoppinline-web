...
export default async function Page({ params }: { params: any }) {
    ...
    return (
        <>
            ...
            <Container>
                <ThisWeekProductFeed lang={lang} variant={"furniture"} className={"mb-8 lg:mb-15 pb-8 lg:pb-10"} />
                <CollectionOffers lang={lang} variant={"furniture"}  className={"mb-8 lg:mb-15 pb-8 lg:pb-12"} />
