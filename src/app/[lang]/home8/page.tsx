    ...
    return (
        <>
            ...
            <div className={"bg-[#f5f5f5] py-8 lg:py-24  mb-12 lg:mb-24 "}>
                <Container>
                    <CollectionLight lang={lang} className="mb-0" headingPosition={'center-xl'} />
                </Container>
            </div>

            <Container>
                <ThisWeekBestProduct lang={lang} variant={"furniture-3"} className="mb-12 lg:mb-24" />
                <BannerGrid
                    lang={lang}
                    data={gridHero2}
                    grid={3}
                ...
                <TrendingProductFeed lang={lang} className="mb-12 lg:mb-24" variant={'furniture-3'} />
                ...
                <SectionHeader
                    ...
                    lang={lang}
                />
                <LatestblogCarousel lang={lang} className={"mb-8 lg:mb-15"} variant={"home8"} />
