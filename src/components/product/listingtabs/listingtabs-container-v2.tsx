...
const ListingTabsContainer: React.FC<Props> = ({
  ...
  return (
    <div
      className={`xl:flex border border-black/10 rounded bg-white w-full ${showBanner == 'right' && 'flex-row-reverse'}`}
    >
      {showBanner && (
      ...
      <div
        className={`${showBanner ? 'banner-main-content' : 'popular-main-content'} p-2.5 grow`}
      >
        <ProductsCarousel
          lang={lang}
          products={data}
