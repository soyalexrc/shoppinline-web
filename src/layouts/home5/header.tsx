              ...
              <Container className="2xl:max-w-[1700px]">
                <div className="flex justify-between items-center">
                  ...
                  <div className="categories-header-button relative  flex-shrink-0 w-52 xl:w-60">
                    <button
                      className="text-white text-sm border-black/10 min-h-[48px] focus:outline-none w-full font-semibold py-2 flex items-center"
                  ...
                  <HeaderMenu
                    ...
                    className="flex transition-all duration-200 ease-in-out"
                    classLink={"md:text-white group-hover:text-[#16bcdc]"}
                    lang={lang}
                    bgPrimary={true}
                  />
                  {/* End of main menu */}
                  ...
                  <div className="text-white ms-auto flex items-center flex-shrink-0">
